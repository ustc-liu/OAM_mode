...
Psi0 = -tanh((abs(r)-1)*40);
Psi0 = Psi0-min(Psi0(:));
Psi0 = Psi0/sqrt(sum(sum(abs(Psi0).^2))*dx*dy);
...
hold on
plot((-1i*dt)*12*(Nt1+Nt2)*ones(100,1),linspace(0.5,1,100),'--r')
%plot((-1i*dt)*16*(Nt1+Nt2)*ones(100,1),linspace(0.5,1,100),'--r')
